 ...
 * 最近播放的列表
 */
public class NearPlay extends DataSupport implements Parcelable {
    ...
    public NearPlay(String title, String dataUrl, String displayName, String albumName, String artist, float size) {
        this.title = title;
    ...
    public NearPlay(int duration, int track, int artist_id, int albumId, String albumKey,
    ...
    public NearPlay(Music music) {
        this.duration = music.getDuration();
        this.track = music.getTrack();
        this.artist_id = music.getArtist_id();
        this.albumId = music.getAlbumId();
        this.albumKey = music.getAlbumKey();
        this.bookMark = music.getBookMark();
        this.dateAdded = music.getDateAdded();
        this.composer = music.getComposer();
        this.title = music.getTitle();
        this.dataUrl = music.getDataUrl();
        this.displayName = music.getDisplayName();
    ...
    public NearPlay(String title, String dataUrl) {
        this.title = title;
        this.dataUrl = dataUrl;
    }
     ...
     * @param a
     */
    public NearPlay(String albumName, String artist, int a) {
        this.albumName = albumName;
        this.artist = artist;
    }
